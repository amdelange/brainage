...
def plot(dataset,model,agerange,corr):
    ...
    for a in age_ranges:
        ...
        file_name = f"../output/{dataset_names[dataset]}{suff}_metrics{model_name}_fixed_train_range.json"
    ...
    fig.savefig(f"../plots/additional_plots/{dataset}_metric_results_corr_{corr}{model_name}_age_{agerange}_fixed_train_range.pdf")
