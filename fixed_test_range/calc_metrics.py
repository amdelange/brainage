...
def calc_metrics(dataset, model, agerange, age):
    ...
    file_name = f"../data/{dataset_name}{suff}_with_pred{model_name}_fixed_test_range"
    ...
    with open(f"../output/{dataset_name}{suff}_metrics{model_name}_fixed_test_range.json","w") as f:
